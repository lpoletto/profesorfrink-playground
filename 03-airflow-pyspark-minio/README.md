...
airflow:
  ...
  variables:
    - variable_name: JARS_PATH
      variable_value: '/usr/local/spark-jars/hadoop-aws-3.3.4.jar,/usr/local/spark-jars/aws-java-sdk-bundle-1.12.262.jar,/usr/local/spark-jars/postgresql-42.6.0.jar'
```
